...
class BatchExpansionTop1Scorer(SpeculativeScorer):
    ...
    def score_proposals(
        ...
        with nvtx_range("score_proposals.tolist"):
        ...
        with nvtx_range("score_proposals.expand_batch"):
        ...
        with nvtx_range("score_proposals.execute_model"):
        ...
        with nvtx_range("score_proposals.contract_batch"):
